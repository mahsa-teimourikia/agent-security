...
`E` when a globally unique label is useful. The currently published eleven-course
...
## Foundation sequence (two published, five reading)
...
These chapters establish the conceptual sequence. Foundation 01 and 02 have
passed the publication gate. The remaining chapters are not labelled as published Hub
