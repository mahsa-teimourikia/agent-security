# AI Agent Security Engineering curriculum

The numbered curriculum is the canonical learning path. It follows one
...
## Foundation sequence (implemented)
...
## Production / enterprise sequence
...
The runtime lab adds delegation attenuation, egress allowlisting, checkpoint
resume checks, idempotent effects, revocation, and release-gate evidence. It is
the executable baseline for courses 08–36; each course specifies the attack and
production upgrade that extends it.
